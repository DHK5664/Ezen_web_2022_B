...
// 2. if 형태2
if(10>3) console.log('참1'); console.log('1.10이 더 크다.');		// [X]2번째 console은 if랑 상관없이 무조건 실행
if(10>20) console.log('참2'); console.log('2.10이 더 크다.'); 		// [X]2번째 console은 if랑 상관없이 무조건 실행
...
/* 
	1. prompt로 정수 1개 입력받아 90 이상이면 합격 아니면 '탈락' console 출력
	2. prompt로 성별 입력받아 
		'M' 또는 'm' 또는 '남' 또는 '남자' 일 경우 '남자이군요' 출력
		'W' 또는 'w' 또는 '여' 또는 '여자' 일 경우 '여자이군요' 출력
		그외 '남자: m, M,남,남자 여자:w, W , 여 , 여자로 입력해주세요' 라고 console 출력
...
// 만약에 성별이 M 이거나 성별이 m 이거나 성별이 남 이거나 성별이 남자 이면 남자이군요
else if(성별=='W' || 성별=='w' || 성별=='여' || 성별=='여자'){console.log('여자이군요')}
else{console.log('남자: m, M,남,남자형식 / 여자:w, W , 여 , 여자로 입력해주세요')}
