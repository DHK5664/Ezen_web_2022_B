...
//* 첨부파일 이미지 미리보기 [ 업로드랑 상관X ]
	// 정책 : 사용자[클라이언트]에 운영체제[폴더경로] 접근 불가
...
/*	let info = {
	...
	$.ajax({
		url : "/jspweb/member" ,	// 서블릿크래스의 @WebServlet("/member")
		method : "post",			// 메소드 선택
		data : info,
		success : (r)=>{
			console.log('ajax응답');
