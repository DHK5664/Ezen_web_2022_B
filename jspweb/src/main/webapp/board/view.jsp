			...
			<div class="viewtop">
				...
				<div class="rviewtop">
					...
					<div>
						...
						<span onclick="bIncrease(2)"> <i class="far fa-thumbs-up"></i> <span class="bup"> 1</span></span>
						<span onclick="bIncrease(3)"> <i class="far fa-thumbs-down"></i> <span class="bdown"> 20</span></span>
					</div>
				</div>
			</div>
