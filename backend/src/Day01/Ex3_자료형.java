...
public class Ex3_자료형 { // class s
	...
	public static void main(String[] args) { // main s		
		...
		int var4 = 0xB3;	System.out.println("16진수 : " +var4);// B3[16진수]	--> B3[16진수]
		
		// 2. [ p.43 ] byte 자료형	[ -128 ~ 127 ]
		byte b1 = -128;		System.out.println("byte자료형 :" +b1);
		byte b2 = 127;		System.out.println("byte자료형 :" +b2);
		//byte b3 = 128;	//오류 발생	: 범위 벗어난 데이터
		...
		long l2 = 10000000000L;	//오류 발생 100억
			/* 정수 기본타입 : int		변수에 저장되기 전 자료형이 명시되지 않은 데이터 */ 
			// 데이터 뒤에 L 붙이기 : int -> long 
			// 10000000000 --> int // 10000000000L --> long
		
		// 6. [p.44] char 자료형	[ 각 국의 문자를 0 ~ 65535 ]
			// 문자 '' // 문자열 ""
		...
		// 8. [p.47] float[8자리표현]/double[17자리표현] 자료형
			// float 데이터 뒤에 f
		float f1 = 0.123456789123456789f;	System.out.println("float의 자료형 : " +f1);
		double d1 = 0.123456789123456789;	System.out.println("double의 자료형 : " +d1);
		
		// 9. [p.48] boolean 논리 [true , false ]
		boolean bool1 = true;	System.out.println("boolean자료형 : " +bool1);
		//boolean bool2 = 1;		//오류 발생 : true 혹은 false만 저장 가능
