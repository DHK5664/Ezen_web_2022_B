...
public class Ex1 { // class start
	...
	// 2. 실행되는 코드는 무!조!건!  main함수{} 안에서만 코드 작성한다. !!!
...
/*
 *	public	:	사용범위 뜻 [ 프로젝트 내 모든 곳에서 사용 ]
...
/* 
   ...
   [ 성질 , 행동 ]						성질 , 행동
   	...
   	예) 붕어빵 틀[클래스]
   		...
   		굽기[행동]						붕어빵2[밀가루,팥]
 									...
 									- 붕어빵 서로 다르다.
 	예) SM7 자동차 틀[클래스]
 		속도[성질,속성]				 SM7 자동차1[ 속도=50키로 , 주행 ]
 		주행[행동]					 SM7 자동차2[ 속도=0키로 , 주행X ]
  ...
  자바 100% 객체지향언어
   ...
   객체지향[ OOP ] : 객체들을 모아서 만든 프로그램 [간단하게 레고 생각(블록 하나하나 객체이고 모여서 구조물이 됨)]
