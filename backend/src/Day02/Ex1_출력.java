...
public class Ex1_출력 { // class s
	...
	public static void main(String[] args) {// main s
		...
		// 4. [p.69]printf( "형식 문자열" , 값 )
		/*
		 * 형식 문자열
		 * 	%d : 정수
		 *  	%자릿수d		오른쪽 자릿수 차지 [ 만일 자릿수에 데이터가 없으면 공백 ]
		 *    	%-자릿수d		왼쪽부터 자릿수 차지 [ 만일 자릿수에 데이터가 없으면 공백 ]
		 *    	%0자릿수d		오른쪽 자릿수 차지 [ 만일 자릿수에 데이터가 없으면 0 ]
		 * 	%f : 실수
		 * 		%자릿수f
		 *  %s : 문자열
		 */
		int value = 123;	/* int라는 4바이트 자료형 상자에 'value'이름으로 123 저장 */
