...
public class Ex2_p532 {
	public static void main(String[] args) {
		...
		System.out.println(now);// 객체명출력시 .toString() 자동으로 들어감 고로 안써두 댐
		...
		System.out.println("현재 월 : " +  (cal.get( Calendar.MONTH )+1));	// 0부터 시작 1월 : 0 2월 : 1 ··· 12월 : 11
		...
		System.out.println("종료일 이 시작일 같은 : " + 시작일.isEqual(종료일));
		...
		dateFormat = new SimpleDateFormat("(년)오늘은 D번째 날");
		System.out.println(dateFormat.format(date) );
		
		dateFormat = new SimpleDateFormat("(월)오늘은 d번쨰 날");
		System.out.println(dateFormat.format(date) );
	}
}
