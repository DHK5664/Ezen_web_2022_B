...
public class 문자열클래스 {
	public static void main(String[] args) {
		...
		String data = "ABC";
			System.out.println(data.hashCode());	// 주소값 : 64578
		data += "DEF";	// - 변경된 것 처럼 보이지만 새로운 참조 할당 [ 효율성 떨어짐 ]
			System.out.println(data.hashCode());	// 주소값 :1923910755 주소값이 달라짐
		...
		StringBuilder data3 = new StringBuilder();
			System.out.println(data3.hashCode());	// 얘넨
		data3.append("ABC");
			System.out.println(data3.hashCode());	// 싹 다
		data3.append("DEF");
			System.out.println(data3.hashCode());	// 똑같다
